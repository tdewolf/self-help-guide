...
| icon:xmark[]
| xmark
| Clear selection or selected items

| icon:rotate0left[]
| rotate-left
| Restore source access of share or export in switchover dashboard when share/export are not yet fixed.
|===
